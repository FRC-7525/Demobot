...
public enum ManagerStates {
	...
	INIDLE(IntakeStates.IDLE, ClimberStates.IDLE, PassthroughStates.IDLE, ShooterStates.IDLE, "REALLYIDLE"),
	IDLE(IntakeStates.IDLE, ClimberStates.IDLE, PassthroughStates.IDLE, ShooterStates.IDLE, "IDLE"),
	INTAKING(IntakeStates.INTAKING, ClimberStates.IDLE, PassthroughStates.IDLE, ShooterStates.IDLE, "INTAKING"),
	...
	FIXEDSHOT(IntakeStates.INTAKING_OUT, ClimberStates.IDLE, PassthroughStates.PASS, ShooterStates.FIXEDSHOOT, "FIXEDSHOOT"),
	WINDUP(IntakeStates.INTAKING_OUT, ClimberStates.IDLE, PassthroughStates.IDLE, ShooterStates.FIXEDSHOOT, "WINDUP"),
	// -------------------------------------------------------- AUTO STATES --------------------------------------------------------
	SHOOT_AUTO(IntakeStates.INTAKING_OUT, ClimberStates.IDLE, PassthroughStates.PASS, ShooterStates.FIXEDSHOOT, "SHOOT_AUTO"),
	WINDUP_AUTO(IntakeStates.INTAKING_OUT, ClimberStates.IDLE, PassthroughStates.IDLE, ShooterStates.FIXEDSHOOT, "WINDUP_AUTO"),
	...
	REVERSE_PASS(IntakeStates.INTAKING_OUT, ClimberStates.IDLE, PassthroughStates.REVERSE, ShooterStates.IDLE, "REVERSE_PASS");
	...
	ManagerStates(IntakeStates intakeState, ClimberStates climberState, PassthroughStates passthroughState, ShooterStates shooterState, String stateString) {
